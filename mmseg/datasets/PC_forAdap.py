...
class PCDataset_forAdap(CustomDataset):
    """Paris and Chicago dataset for Domain adaptation.

    Args:
        split (str): Split txt file for domain A of Paris and Chicago dataset .
    """

    CLASSES = ('Backgroud', 'Road', 'Building')
    ...
    def __init__(self, 
        ...
        super(PCDataset_forAdap, self).__init__(
