...
class GRDataset_forAdap(CustomDataset):
    """Gaofen-2 and LoveDA Rural dataset for Domain adaptation.
    ...
    '''
    ## 5 CLS mode
    CLASSES = ('background', 'bulit-up', 'Farmland', 'Forest-Meadow', 'water')

    PALETTE = [[0, 0, 0], [255, 0, 0], [0, 255, 0], [0, 255, 255], [0, 0, 255]]
    '''
    ## 4 CLS with 'background' ignored
    CLASSES = ('bulit-up', 'Farmland', 'Forest-Meadow', 'water')
    ...
    def __init__(self, 
        ...
        super(GRDataset_forAdap, self).__init__(
